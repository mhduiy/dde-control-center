...
class LastoreManagerJobDBusProxy : public QObject
{
    Q_OBJECT
public:
    explicit LastoreManagerJobDBusProxy(const QString &jobPath, QObject *parent = nullptr);
    ~LastoreManagerJobDBusProxy();
