                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                ...
                                model: privacyFolderItem.isExpaned ? [
                                    { name: "文档", checked: privacyFolderItem.dataModel.documentPermission, premission: ApplicationItem.DocumentFoldersPermission},
                                    { name: "桌面", checked: privacyFolderItem.dataModel.desktopPermission, premission: ApplicationItem.DesktopFoldersPermission},
                                    { name: "图片", checked: privacyFolderItem.dataModel.picturePermission, premission: ApplicationItem.PictureFoldersPermission},
                                    { name: "视频", checked: privacyFolderItem.dataModel.videoPermission, premission: ApplicationItem.VideoFoldersPermission},
                                    { name: "音乐", checked: privacyFolderItem.dataModel.musicPermission, premission: ApplicationItem.MusicFoldersPermission},
                                    { name: "下载", checked: privacyFolderItem.dataModel.downloadPermission, premission: ApplicationItem.DownloadFoldersPermission},
                                    ] : []
